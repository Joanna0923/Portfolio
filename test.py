...
#kolejność
#1. `cd C:\Users\marko\OneDrive\Dokumenty\GitHub\Portfolio\portfolio`
#2. `poetry shell
#3. cd ..
#3. python test1.py

names = ["Asia","basia","kasia","zosia"] # lista stringów
#names = [] # lista dictów - kluczami mają być first_name, email ...
#{"first_name":"Asia","email":"adsv"}
